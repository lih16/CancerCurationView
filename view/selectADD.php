...
<br>
<button class="searchbutton"  onclick="narrative(event,'ll','33','44',0);">Upload</button>
&nbsp;&nbsp;&nbsp;&nbsp;
<button class="searchbutton"  onclick="narrative(event,'ll','33','44',1);">Preview</button>
&nbsp;&nbsp;&nbsp;&nbsp;
<button class="searchbutton"  onclick="showAnnotation();return false;">Submit</button>
</form>
</div>
