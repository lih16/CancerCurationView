...
<div >
  ...
  <a href="register/forgotPassword"  target="_blank" style="float:center;display: flex;align-items: center;justify-content: center;padding:0px 2px;margin:15px 1px;">Forgot Password?  </a>
  <a href="register/updatePassword"  target="_blank" style="float:center;display: flex;align-items: center;justify-content: center;padding:0px 2px;margin:15px 1px;">Update Password?</a>
