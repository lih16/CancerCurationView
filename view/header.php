...
<button class="searchbutton" onclick="logout();return false;" style="float: right; margin:15px 5px">Log out</button> <a class="searchbutton" href="http://34.235.93.148/CancerCurationView/public/Cancer_curation_viewer_instruction.pdf" target="_blank" style="float: right;position: absolute;top: 50%;left: 50%;transform: translateX(-50%) translateY(-50%);margin:15px 1px;border-radius: 5px 5px 5px 5px;">Help</a>
