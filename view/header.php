...
<button class="searchbutton" onclick="logout();return false;" style="float: right;">Log out</button class="searchbutton">  <a href="http://34.235.93.148/CancerCurationView/public/Cancer_curation_viewer_instruction.pdf" style="float: right;">Help</a>
